...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 107.0, 138.0, 101.0, 22.0 ],
					"text" : "loadmess 0.921"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 229.0, 134.0, 90.0, 22.0 ],
					"text" : "loadmess 0.2"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 52.0, 21.0, 150.0, 62.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 52.0, 94.0, 150.0, 20.0 ],
					"text" : "args # 1 = x dim "
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 2,
					"numoutlets" : 0,
					"patching_rect" : [ 184.0, 395.0, 69.666666666666657, 22.0 ],
					"text" : "fftout~ 1"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 184.0, 362.0, 69.666666666666657, 22.0 ],
					"text" : "poltocar~"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 551.104166666666742, 305.0, 115.0, 48.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 673.0, 446.0, 46.0, 22.0 ],
					"text" : "out 2"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 686.0, 424.0, 89.083333333333258, 20.0 ],
					"text" : "x-count to mg"
				}
...
,
					"patching_rect" : [ 39.0, 228.0, 105.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 158.0, 192.0, 48.0, 22.0 ],
					"saved_object_attributes" : 					{
						"attr_comment" : ""
					}
,
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 35.0, 167.0, 70.0, 20.0 ],
					"text" : "raw gain"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 448.833333333333314, 424.0, 156.0, 36.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 285.333333333333314, 424.0, 154.0, 36.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 366.0, 272.0, 56.0, 22.0 ],
					"text" : "sig~ 1."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 158.0, 231.0, 50.0, 22.0 ],
					"text" : "filter $1"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 184.0, 327.0, 171.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 636.0, 394.0, 56.0, 22.0 ],
					"sig" : 0.0
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 151.0, 167.0, 77.0, 20.0 ],
					"text" : "Filtering"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 39.0, 192.0, 48.0, 22.0 ],
					"saved_object_attributes" : 					{
						"attr_comment" : ""
					}
,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "int", "int" ],
					"patching_rect" : [ 588.0, 171.0, 100.0, 22.0 ],
					"text" : "t i i"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 480.0, 305.0, 58.0, 22.0 ],
					"text" : "%~ 1024"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 566.791666666666629, 128.0, 82.625, 22.0 ],
					"text" : "fftinfo~"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 184.0, 272.0, 171.0, 22.0 ],
					"text" : "fftin~ 1"
				}
