...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 680.316666666666606, 477.0, 150.0, 48.0 ],
					"text" : "Scale the bin index according to camera Y-dim."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "int", "int" ],
					"patching_rect" : [ 700.0, 206.0, 59.0, 22.0 ],
					"text" : "change"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "int", "int" ],
					"patching_rect" : [ 578.416666666666629, 441.0, 63.5, 22.0 ],
					"text" : "unpack"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 578.416666666666629, 411.0, 71.0, 22.0 ],
					"text" : "r cam-dim"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 477.316666666666663, 477.0, 200.999999999999943, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 975.339611000000104, 54.75, 153.160389000000123, 50.0 ],
					"text" : "r from-display-routing-bang-sg"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 92.0, 140.0, 101.0, 22.0 ],
					"text" : "loadmess 0.921"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 214.0, 136.0, 90.0, 22.0 ],
					"text" : "loadmess 0.2"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 515.0, 44.0, 115.0, 34.0 ],
					"text" : "multiplyer. printing rate."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 1076.5, 257.0, 52.0, 22.0 ],
					"text" : "#1 $1"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 43.0, 22.0, 150.0, 62.0 ],
					"text" : "This redder this spectrogram prints the higher the energy in that frequency bin."
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 43.0, 95.0, 150.0, 20.0 ],
					"text" : "args # 1 = x dim "
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 1032.0, 188.0, 89.0, 22.0 ],
					"text" : "zl change"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 823.0, 119.0, 228.0, 22.0 ],
					"text" : "t b b"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "int", "int" ],
					"patching_rect" : [ 1032.0, 221.0, 63.5, 22.0 ],
					"text" : "unpack"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 1032.0, 157.0, 90.0, 22.0 ],
					"text" : "v cam-dim"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 515.0, 79.0, 42.0, 22.0 ],
					"text" : "in 5"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 84.0, 369.0, 96.0, 48.0 ],
					"text" : "for spectroscope in UI"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 2,
					"numoutlets" : 0,
					"patching_rect" : [ 184.0, 395.0, 97.0, 22.0 ],
					"text" : "fftout~ 1"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 184.0, 362.0, 97.0, 22.0 ],
					"text" : "poltocar~"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 634.416666666666742, 249.0, 115.0, 48.0 ],
					"text" : "equal to 9 \"frames\"\nper second, if * and / object == 5000."
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 845.0, 483.0, 46.0, 22.0 ],
					"text" : "out 2"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 898.0, 483.0, 89.083333333333258, 20.0 ],
					"text" : "x-count to mg"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 823.0, 51.0, 115.0, 20.0 ],
					"text" : "clock from camera"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 823.0, 79.0, 48.0, 22.0 ],
					"text" : "in 4"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 430.0, 148.0, 86.0, 22.0 ],
					"text" : "r refresh-bang"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 404.0, 184.0, 100.0, 22.0 ],
					"text" : "r start-off-bang"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 862.0, 167.0, 100.0, 22.0 ],
					"text" : "r clear-bang"
				}
...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 22.0, 215.0, 70.0, 22.0 ],
									"text" : "thresh $1"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 22.0, 126.0, 57.0, 22.0 ],
									"text" : "$1 1000"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "bang" ],
									"patching_rect" : [ 22.0, 155.0, 43.5, 22.0 ],
									"text" : "line 0."
								}
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "", "bang" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 22.0, 185.0, 50.0, 22.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 22.0, 82.0, 78.0, 36.0 ],
									"text" : "scale 0. 0.1 0.8 0.5"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "float" ],
									"patching_rect" : [ 22.0, 51.0, 62.0, 22.0 ],
									"text" : "- 0.921"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 22.0, 9.0, 30.0, 30.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 22.0, 252.0, 30.0, 30.0 ]
								}
...
,
					"patching_rect" : [ 24.0, 230.0, 105.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 143.0, 194.0, 48.0, 22.0 ],
					"saved_object_attributes" : 					{
						"attr_comment" : ""
					}
,
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 20.0, 169.0, 70.0, 20.0 ],
					"text" : "raw gain"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 505.816666666666663, 552.0, 156.0, 36.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 342.316666666666663, 552.0, 154.0, 36.0 ],
					"text" : "jit.poke~ #0_spectrum 2 2"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 418.0, 288.0, 56.0, 22.0 ],
					"text" : "sig~ 1."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 143.0, 233.0, 50.0, 22.0 ],
					"text" : "filter $1"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 184.0, 327.0, 253.0, 22.0 ],
					"text" : "gen~ red-green-amp"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 808.0, 431.0, 56.0, 22.0 ],
					"sig" : 0.0
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 136.0, 169.0, 77.0, 20.0 ],
					"text" : "Filtering"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 24.0, 194.0, 48.0, 22.0 ],
					"saved_object_attributes" : 					{
						"attr_comment" : ""
					}
,
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 588.0, 171.0, 131.0, 22.0 ],
					"text" : "t f f f"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 588.0, 206.0, 67.0, 22.0 ],
					"text" : "* 8000."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 733.0, 350.0, 80.0, 36.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 480.0, 272.0, 54.0, 22.0 ],
					"text" : "/~ 8000."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 480.0, 242.0, 127.0, 22.0 ],
					"text" : "count~ 0 44100 1 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 480.0, 305.0, 62.0, 22.0 ],
					"text" : "%~ 1024."
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 823.0, 350.0, 35.0, 22.0 ],
					"saved_object_attributes" : 					{
						"attr_comment" : ""
					}
,
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 823.0, 206.0, 139.0, 22.0 ],
					"text" : "jit.matrix #0_spectrum"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "jit_matrix", "" ],
					"patching_rect" : [ 823.0, 296.0, 139.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "jit_matrix", "" ],
					"patching_rect" : [ 823.0, 249.0, 139.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 1076.5, 292.0, 75.0, 22.0 ],
					"text" : "prepend dim"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "jit_matrix", "" ],
					"patching_rect" : [ 1076.5, 325.0, 232.0, 22.0 ],
					"text" : "jit.matrix #0_spectrum 4 char 1024 720"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 566.791666666666629, 134.0, 82.625, 22.0 ],
					"text" : "fftinfo~"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 184.0, 272.0, 206.0, 22.0 ],
					"text" : "fftin~ 1"
				}
...
, 			{
				"patchline" : 				{
					"color" : [ 1.0, 0.125490196078431, 0.0, 1.0 ],
...
, 			{
				"patchline" : 				{
					"color" : [ 0.0, 0.87843137254902, 0.0, 1.0 ],
